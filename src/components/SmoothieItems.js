...
import smoothieHeader from '../images/smoothieHeader.png'; // Update with the correct image for smoothies
...
const SmoothieItems = ({ goToMainMenu, cartItems, setCartItems }) => {
